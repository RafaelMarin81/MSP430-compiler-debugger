...
#                                                                              #
# This script is a modified version of the one created by Hossein Shafagh and  #
# hosted here: http://wiki.contiki-os.org/doku.php?id=msp430x                  #
#                                                                              #
...
#                                                                              #
# Copyright (c) 2013, Odin Solution                                            #
# Author: Rafael Marin-Perez (rafael.marin81@gmail.com)                        #
#                                                                              #
################################################################################
INSTALL_PREFIX="/opt/mspgcc-4.7.2"
#INSTALL_PREFIX="${HOME}/mspgcc-4.7.2"
echo The installatoin prefix:$INSTALL_PREFIX
# Switch to the tmp directory
mkdir tmp 
cd tmp
# Posible pre-requisite
