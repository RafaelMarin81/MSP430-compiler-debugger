...
//    printc_err("flash_bsl: flash_bsl_recv.  header received\n");
...
//    printc_err("flash_bsl: exit_via_dtr_rts.\n");
...
/*        
    if (sport_set_modem(dev->serial_fd, ~ SPORT_MC_DTR) != 0) {
        return -1;
    }

    return;
*/
    sport_flush(dev->serial_fd);    // TODO: Pak
