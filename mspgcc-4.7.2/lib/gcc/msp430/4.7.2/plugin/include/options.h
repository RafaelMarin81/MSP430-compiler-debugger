...
#endif
#ifdef GENERATOR_FILE
extern enum msp430_section_region_e msp430_code_region;
#else
  enum msp430_section_region_e x_msp430_code_region;
#define msp430_code_region global_options.x_msp430_code_region
#endif
#ifdef GENERATOR_FILE
extern enum msp430_cpu_e msp430_cpu;
#else
  enum msp430_cpu_e x_msp430_cpu;
#define msp430_cpu global_options.x_msp430_cpu
#endif
#ifdef GENERATOR_FILE
extern enum msp430_section_region_e msp430_data_region;
#else
  enum msp430_section_region_e x_msp430_data_region;
...
#else
  int x_msp430_ivcnt;
#define msp430_ivcnt global_options.x_msp430_ivcnt
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern enum msp430_memory_model_e msp430_memory_model;
#else
  enum msp430_memory_model_e x_msp430_memory_model;
#define msp430_memory_model global_options.x_msp430_memory_model
#endif
#ifdef GENERATOR_FILE
extern enum msp430_mpy_e msp430_mpy;
#else
  enum msp430_mpy_e x_msp430_mpy;
#define msp430_mpy global_options.x_msp430_mpy
#endif
#ifdef GENERATOR_FILE
...
#define MASK_C20 (1 << 1)
#define MASK_D20 (1 << 2)
#define MASK_ISR20 (1 << 3)
#define MASK_NOINT_HWMUL (1 << 4)
#define MASK_SR20 (1 << 5)

#define TARGET_A20 ((target_flags & MASK_A20) != 0)
#define TARGET_C20 ((target_flags & MASK_C20) != 0)
#define TARGET_D20 ((target_flags & MASK_D20) != 0)
#define TARGET_ISR20 ((target_flags & MASK_ISR20) != 0)
#define TARGET_NOINT_HWMUL ((target_flags & MASK_NOINT_HWMUL) != 0)
#define TARGET_SR20 ((target_flags & MASK_SR20) != 0)
...
enum opt_code
{
  ...
  OPT_mc16 = 985,                            /* -mc16 */
  OPT_mc20 = 986,                            /* -mc20 */
  OPT_mcode_region_ = 987,                   /* -mcode-region= */
  OPT_mcpu_ = 988,                           /* -mcpu= */
  OPT_md16 = 989,                            /* -md16 */
  OPT_md20 = 990,                            /* -md20 */
  OPT_mdata_region_ = 991,                   /* -mdata-region= */
  OPT_mdisable_watchdog = 992,               /* -mdisable-watchdog */
  OPT_menable_libcall_shift = 993,           /* -menable-libcall-shift */
  OPT_misr20 = 994,                          /* -misr20 */
  OPT_mivcnt_ = 995,                         /* -mivcnt= */
  OPT_mmcu_ = 996,                           /* -mmcu= */
  OPT_mmemory_model_ = 997,                  /* -mmemory-model= */
  OPT_mmpy_ = 998,                           /* -mmpy= */
  OPT_mnoint_hwmul = 999,                    /* -mnoint-hwmul */
  OPT_msr16 = 1000,                          /* -msr16 */
  OPT_msr20 = 1001,                          /* -msr20 */
  OPT_n = 1002,                              /* -n */
  ...
  OPT_print_objc_runtime_info = 1024,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1025,               /* -print-prog-name= */
  OPT_print_search_dirs = 1026,              /* -print-search-dirs */
  OPT_print_sysroot = 1027,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1028,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1029,                          /* -quiet */
  OPT_r = 1030,                              /* -r */
  OPT_remap = 1031,                          /* -remap */
  OPT_s = 1032,                              /* -s */
  OPT_s_bc_abi = 1033,                       /* -s-bc-abi */
  OPT_save_temps = 1034,                     /* -save-temps */
  OPT_save_temps_ = 1035,                    /* -save-temps= */
  OPT_shared = 1036,                         /* -shared */
  OPT_shared_libgcc = 1037,                  /* -shared-libgcc */
  /* OPT_specs = 1038, */                    /* -specs */
  OPT_specs_ = 1039,                         /* -specs= */
  OPT_static = 1040,                         /* -static */
  OPT_static_libgcc = 1041,                  /* -static-libgcc */
  OPT_static_libgcj = 1042,                  /* -static-libgcj */
  OPT_static_libgfortran = 1043,             /* -static-libgfortran */
  OPT_static_libgo = 1044,                   /* -static-libgo */
  OPT_static_libstdc__ = 1045,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1046, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1047, */                /* -std=c++0x */
  OPT_std_c__11 = 1048,                      /* -std=c++11 */
  OPT_std_c__98 = 1049,                      /* -std=c++98 */
  OPT_std_c11 = 1050,                        /* -std=c11 */
  /* OPT_std_c1x = 1051, */                  /* -std=c1x */
  /* OPT_std_c89 = 1052, */                  /* -std=c89 */
  OPT_std_c90 = 1053,                        /* -std=c90 */
  OPT_std_c99 = 1054,                        /* -std=c99 */
  /* OPT_std_c9x = 1055, */                  /* -std=c9x */
  OPT_std_f2003 = 1056,                      /* -std=f2003 */
  OPT_std_f2008 = 1057,                      /* -std=f2008 */
  OPT_std_f2008ts = 1058,                    /* -std=f2008ts */
  OPT_std_f95 = 1059,                        /* -std=f95 */
  OPT_std_gnu = 1060,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1061, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1062, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1063,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1064,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1065,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1066, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1067, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1068,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1069,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1070, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1071, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1072,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1073, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1074, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1075, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1076,                     /* -std=legacy */
  OPT_symbolic = 1077,                       /* -symbolic */
  OPT_t = 1078,                              /* -t */
  OPT_time = 1079,                           /* -time */
  OPT_time_ = 1080,                          /* -time= */
  OPT_traditional = 1081,                    /* -traditional */
  OPT_traditional_cpp = 1082,                /* -traditional-cpp */
  OPT_trigraphs = 1083,                      /* -trigraphs */
  OPT_u = 1084,                              /* -u */
  OPT_undef = 1085,                          /* -undef */
  OPT_v = 1086,                              /* -v */
  OPT_version = 1087,                        /* -version */
  OPT_w = 1088,                              /* -w */
  OPT_wrapper = 1089,                        /* -wrapper */
  OPT_x = 1090,                              /* -x */
  OPT_z = 1091,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
