/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../gcc-4.7.2/gcc/config/msp430/msp430.md'.  */
...
extern int msp430x_int16_operand (rtx, enum machine_mode);
extern int msp430x_unsafe_indexed_address_operand (rtx, enum machine_mode);
extern int msp430x_unsafe_indexed_memory_operand (rtx, enum machine_mode);
extern int msp430x_a20_operand (rtx, enum machine_mode);
extern int msp430x_ext_address_operand (rtx, enum machine_mode);
extern int msp430x_ext_memory_operand (rtx, enum machine_mode);
extern int msp430x_ext_operand (rtx, enum machine_mode);
